...
./run_DRP-AI_translator_V2L.sh ${MODEL}_${IMG_SRC} \
	...
	-prepost ../Renesas_software/${DRP_SUPPORT_PACKAGE}/rzv2l_drpai-sample-application/app_usbcam_http/etc/${MODEL}_${IMG_SRC}/prepost_d-${MODEL}.yaml \
	-addr    ../Renesas_software/${DRP_SUPPORT_PACKAGE}/rzv2l_drpai-sample-application/app_usbcam_http/etc/${MODEL}_${IMG_SRC}/addrmap_in_d-${MODEL}.yaml
cd -
