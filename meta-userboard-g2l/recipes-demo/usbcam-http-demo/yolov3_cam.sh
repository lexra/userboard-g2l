...
./run_DRP-AI_translator_V2L.sh ${MODEL}_${IMG_SRC} \
	...
	-prepost ../build_smarc-rzv2l/tmp/work/aarch64-poky-linux/usbcam-http-demo/git-r0/git/usbcam_http_drp-ai/etc/${MODEL}_${IMG_SRC}/prepost_d-${MODEL}.yaml \
	-addr ../build_smarc-rzv2l/tmp/work/aarch64-poky-linux/usbcam-http-demo/git-r0/git/usbcam_http_drp-ai/etc/${MODEL}_${IMG_SRC}/addrmap_in_d-${MODEL}.yaml
cd -
